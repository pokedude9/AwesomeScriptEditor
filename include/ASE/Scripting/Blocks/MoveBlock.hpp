...
#ifndef __ASE_MOVEBLOCK_HPP__
#define __ASE_MOVEBLOCK_HPP__
...
namespace ase
{
    ...
    ///
    ///////////////////////////////////////////////////////////
    class MoveBlock : public ScriptBlock {
    public:
        ...
        ///
        ///////////////////////////////////////////////////////////
        MoveBlock(UInt32 offset);


        ///////////////////////////////////////////////////////////
        /// \brief Reads all the applymovement data.
        ...
        ///////////////////////////////////////////////////////////
        /// \brief Writes all the applymovement data.
        /// \param rom Currently loaded ROM file
        ///
        ///////////////////////////////////////////////////////////
